  ...
  async function fetchActivities() {
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        spotsLeft.innerHTML = `<strong>Availability:</strong> ${details.max_participants - details.participants.length} spots left`;
        ...
        activityCard.append(title, description, schedule, spotsLeft, participantsSection);
